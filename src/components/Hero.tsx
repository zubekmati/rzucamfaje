      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <Link
              href="/zacznij-dzis"
              className="inline-flex items-center justify-center px-7 py-3.5 rounded-xl border border-transparent bg-white text-green-900 font-bold text-base hover:bg-green-50 transition-colors shadow-lg shadow-green-950/30"
            >
